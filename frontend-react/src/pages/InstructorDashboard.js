...
const InstructorDashboard = () => {
  ...
  const handleUpdate = async (course) => {
    const newPrice = prompt("Nouveau prix ?", course.price);
    ...
    try {
      ...
      setError(
        err.response?.data?.error || "Erreur lors de la mise à jour du cours"
      );
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="Ex: Backend, JavaScript, Node.js"
            />
          </div>
